...
import { BenefitType, SeletedPage } from "../../shared/types"
...
const Benefits = ({setSelectedPage}: Props) => {
  return (
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
      <motion.div  onViewportEnter={()=> setSelectedPage(SeletedPage.Benefits)}>
        {/*Header */}
        <motion.div
        initial="hidden"
        whileInView="visible"
          ...
          <div>
            {/*TITLE */}
              <div className="relative">
                ...
                >
                  <HText>MILLIONS HAPPY MEMBERS GETTING{' '}
            ...
            {/*DESCRIPTION */}
              <motion.div 
                ...
                whileInView="visible"
                viewport={{ once: true, amount: 0.5 }}
                transition={{delete:0.2, duration: 0.5 }}
                variants={{
                  hidden: { opacity: 0, x: -50 },
                  visible: { opacity: 1, x: 0 },
                }}
